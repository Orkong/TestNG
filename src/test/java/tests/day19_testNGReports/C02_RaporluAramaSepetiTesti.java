...
public class C02_RaporluAramaSepetiTesti extends TestBaseRapor {
    ...
    public void aramaSepetiTesti(){
        ...
        extentTest.info("Kullanici test otomasyonu sayfasina gider");
        ...
        extentTest.info("listelenen ilk urune tiklar");
        ...
        extentTest.pass("kaydettigi urun ile sepetteki urun isminin ayni oldugunu test eder");
